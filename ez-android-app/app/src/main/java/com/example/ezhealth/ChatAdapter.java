...
public class ChatAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private ArrayList<com.example.ezhealth.Message> messageArrayList;


    public ChatAdapter(ArrayList<com.example.ezhealth.Message> messageArrayList) {
    ...
    public int getItemViewType(int position) {
        com.example.ezhealth.Message message = messageArrayList.get(position);
