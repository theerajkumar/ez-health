...
public class chatbotmainactivity extends AppCompatActivity {
  ...
  protected void onCreate(Bundle savedInstanceState) {
      ...
      Log.i(TAG, "Permission to record was already granted");
        ...
        recyclerView.addOnItemTouchListener(new RecyclerTouchListener(getApplicationContext(), recyclerView, new ClickListener() {
            ...
            public void onClick(View view, final int position) {
                com.example.ezhealth.Message audioMessage = (com.example.ezhealth.Message) messageArrayList.get(position);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.chatbotmenu, menu);
        return true;
    }
    ...
    private void recordMessage() {
        if (listening != true) {
            ...
            listening = true;
            Toast.makeText(chatbotmainactivity.this, "Listening....Click to Stop", Toast.LENGTH_LONG).show();

        } else {
            try {
                microphoneHelper.closeInputStream();
                listening = false;
                Toast.makeText(chatbotmainactivity.this, "Stopped Listening....Click to Start", Toast.LENGTH_LONG).show();
            } catch (Exception e) {
                e.printStackTrace();
            }
    ...
    private void showError(final Exception e) {
        runOnUiThread(new Runnable() {
            @Override
            public void run() {
                Toast.makeText(chatbotmainactivity.this, e.getMessage(), Toast.LENGTH_SHORT).show();
                e.printStackTrace();
            }
        });
    }
